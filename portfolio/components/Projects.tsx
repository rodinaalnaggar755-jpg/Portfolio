...
const projects = [
 {
  icon: "💪",  
  title: "Gym Website",
  description: "A modern, fully responsive fitness platform featuring dynamic workout programs, membership plans, trainer profiles, and an interactive BMI calculator with smooth user experience.",
